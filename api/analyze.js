...
{"question_type": "Must Be True|Strengthen|Weaken|Assumption|Flaw|Premise & Conclusion|Context vs. Argument|Concession|Parallel Reasoning", "segments": [{"id":"s1","text":"...","tag":"context"}], "identification_test": "...", "formula": "...", "formula_applied": "...", "steps": ["...", "..."], "traps": ["...", "..."], "answer_analysis": [{"letter":"A","verdict":"wrong","reason":"..."}]}`;
