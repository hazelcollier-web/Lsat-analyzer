...
{"question_type": "${VALID_TYPES.join('|')}", "segments": [{"id":"s1","text":"...","tag":"context","reason":"..."}], "identification_test": "...", "formula": "...", "formula_applied": "...", "steps": ["...", "..."], "traps": ["...", "..."], "answer_analysis": [{"letter":"A","verdict":"wrong","reason":"..."}]}`;
